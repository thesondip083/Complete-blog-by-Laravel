            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >{{$setdata->site_name}}</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">My name is Sondip Poul Singh. I am 24 years old residing in Dhaka,Bangladesh. I am a professional Web designer who has achieved a Bachelor degree in Computer Science from Bangladesh University of Business and Technology. Currently, I am planning to get a Master's degree from Jahangirnagar University. This is my personal website that helps showcase my recent works. Hope you enjoy going through my work.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setdata->contact_number}}</a>
                            <p class="sub-title">Sun-Thurs 9am-6pm</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setdata->contact_mail}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setdata->address}}</a>
